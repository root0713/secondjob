package com.mlog.comm.property;
...
public class AdminProperties extends PropertyPlaceholderConfigurer {
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
		...
		}catch(BeanInitializationException be){
			throw new BeanInitializationException("!!!!!!!!!!!! It's probably because SERVER_FPROFILE is not set, Make sure that -Dspring.profiles.active = xxx( dev or prod ) option is added to JAVA_OPTS  !!!!!!!!!!!! ");
		}
	}
